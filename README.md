## vrpn (noetic) - 7.34.0-2

The packages in the `vrpn` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic vrpn` on `Mon, 01 Feb 2021 20:49:49 -0000`
...
- rosdistro version: `7.34.0-1`
- old version: `7.34.0-1`
- new version: `7.34.0-2`
...
## vrpn (melodic) - 7.34.0-0

The packages in the `vrpn` repository were released into the `melodic` distro by running `/usr/local/bin/bloom-release -t melodic -r melodic vrpn` on `Mon, 25 Jun 2018 17:53:38 -0000`
...
The packages in the `vrpn` repository were released into the `lunar` distro by running `/usr/local/bin/bloom-release -r lunar -t lunar vrpn` on `Thu, 30 Nov 2017 04:36:57 -0000`
...
- release repository: https://github.com/ros-drivers-gbp/vrpn-release.git
- rosdistro version: `7.33.1-2`
- old version: `7.33.1-3`
- new version: `7.33.1-4`
...
The packages in the `vrpn` repository were released into the `lunar` distro by running `/usr/local/bin/bloom-release -r lunar -t lunar vrpn` on `Thu, 30 Nov 2017 03:37:54 -0000`
...
- release repository: https://github.com/ros-drivers-gbp/vrpn-release.git
- rosdistro version: `7.33.1-2`
- old version: `7.33.1-2`
- new version: `7.33.1-3`
